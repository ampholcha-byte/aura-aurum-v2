...
- **Header (Home):** โลโก้เหรียญ DEEGGOLD จริง (`public/deeggold-logo.png`, 131KB, แสดงผล 44px ผ่าน `next/image` + `priority`) แทนวงกลม CSS · ชื่อแบรนด์แยก 2 บรรทัด "ทองแท่ง 96.5%" / "By DEEGGOLD" · ป้าย "ยืนยันเบอร์โทรแล้ว" ชิดขวาในระนาบเดียวกับชื่อแบรนด์ · วงกลมโปรไฟล์ "สม" 40px พร้อม aria-label
...
- ไฟล์โลโก้เวอร์ชันแรก 2.7MB → บีบอัดเหลือ 131KB (สลับไฟล์ที่ path เดิม ไม่แก้โค้ด)
